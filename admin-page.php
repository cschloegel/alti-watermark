                            ...
                            <tbody>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        ...
                                        <p class="description"><?php _e('Real size is actually', 'altiwatermark'); ?> <strong><?php $imageSize = getimagesize( $acw_relativePaths['adminToPlugins'].'/'.$acw_watermark['name']); echo $imageSize[0].'x'.$imageSize[1]; ?>px</strong>. <?php _e('The background gradient is for contrast check.', 'altiwatermark'); ?></p>
                                        <?php } ?>
                                    </td>
                                </tr>
